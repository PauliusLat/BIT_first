<div class="innermenu" id="menuStart">
    ...
    <div class="cont sm-17-24">
        ...
        ?>
            <div class="menuItem">
                <?php
                // _dc($menu->names[$index]);
                if (is_array($menu->names[$index])) {
                ?>
                    <div class="submenu sm-17-24">
                        <?php
                        foreach (range(0, (count($menu->names[$index]) - 1)) as $subindex) {
                        ?>

                            <div class="draggable child" id="addDrag" draggable="true">
                                <?php
                                $wpPage = get_page_by_title($menu->pages[$index][$subindex], 'OBJECT', 'page');
                                $pagePost = $page->get($wpPage->ID);
                                $link = $pagePost->getLink();
                                $name = $menu->names[$index][$subindex];
                                ?>
                                <div class="menuName">
                                    <label for="">
                                    </label>
                                ...
                                <div class="menuSelect">
                                    ...
                                    <select class="select-css submenuSelect" style="display:block;" id="standard-select">
                                        <option value="<?= $pagePost->getLink() ?>" selected><?= $menu->pages[$index][$subindex] ?></option>>
                                        <?php
