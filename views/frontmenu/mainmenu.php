        ...
        ?>
                <div class="menuItem">
                    ...
                    <div class="submenu sm-17-24">
                        <?php
                        foreach (range(0, (count($menu->names[$index + 1]) - 1)) as $subindex) {
                        ?>

                            <div class="draggable child" id="addDrag" draggable="true">
                                <?php
                                $wpPage = get_page_by_title($menu->pages[$index + 1][$subindex], 'OBJECT', 'page');
                                $pagePost = $page->get($wpPage->ID);
                                $link = $pagePost->getLink();
                                $name = $menu->names[$index + 1][$subindex];
                                ?>
                                <div class="menuName">
                                    <label for="">
                                    </label>
                                ...
                                <div class="menuSelect">
                                    ...
                                    <select class="select-css submenuSelect" style="display:block;" id="standard-select">
                                        <option value="<?= $pagePost->getLink() ?>" selected><?= $menu->pages[$index + 1][$subindex] ?></option>>
                                        <?php
                                        foreach ($pages as $value) {
                                        ?>
                                            <option><?= $value->post_title ?></option>
            ...
            } else if (is_array($menu->names[$index])) {
                continue;
            } else {
            ?>
                <div class="menuItem">
