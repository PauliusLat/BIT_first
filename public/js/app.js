...
new _tag_js__WEBPACK_IMPORTED_MODULE_3__["default"](".tag");
...
var Tag = /*#__PURE__*/function () {
  function Tag(target) {
    ...
    this.path = "/wordpress/wp-content/plugins/BIT_first/api/?route=";
    this.uri = document.location.origin;
    this.init(); // this.tagStore = tagStore();
    // this.tagStore();
  }
  ...
  _createClass(Tag, [{
    key: "init",
    value: function init() {
      var DOM = document.querySelector(this.target); // console.log(DOM);

      if (DOM) {
        axios__WEBPACK_IMPORTED_MODULE_0___default.a.post(this.uri + this.path + "tag_create", {}).then(function (response) {
          ...
          if (response.status == 200 && response.statusText == "OK") {
            ...
            submit.addEventListener("click", function () {
              var text = document.getElementById("tag-name").value;
              call.tagStore(text);
              console.log(text);
            });
          }
    ...
    key: "tagStore",
    value: function tagStore(text) {
      // let text = document.getElementById("tag_name").value;
      console.log(text);
      console.log(this.uri + this.path + "tag_store");
      axios__WEBPACK_IMPORTED_MODULE_0___default.a.post(this.uri + this.path + "tag_store", {
        name: text
      }).then(function (response) {
